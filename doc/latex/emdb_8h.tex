...
void \hyperlink{emdb_8h_afbf6079856996f619646712e7a698573}{emdb\+\_\+scan} (\hyperlink{struct_e_m_d_b}{E\+M\+D\+B} $\ast$, void $\ast$, void($\ast$)(void $\ast$, unsigned char $\ast$, \hyperlink{struct_entry}{Entry} $\ast$), void($\ast$)(void $\ast$), void($\ast$)(void $\ast$, char $\ast$))
...
\end{DoxyReturn}
\hypertarget{emdb_8h_afbf6079856996f619646712e7a698573}{}\index{emdb.\+h@{emdb.\+h}!emdb\+\_\+scan@{emdb\+\_\+scan}}
\index{emdb\+\_\+scan@{emdb\+\_\+scan}!emdb.\+h@{emdb.\+h}}
\subsubsection[{emdb\+\_\+scan(\+E\+M\+D\+B $\ast$, void $\ast$, void($\ast$)(void $\ast$, unsigned char $\ast$, Entry $\ast$), void($\ast$)(void $\ast$), void($\ast$)(void $\ast$, char $\ast$))}]{\setlength{\rightskip}{0pt plus 5cm}void emdb\+\_\+scan (
\begin{DoxyParamCaption}
\item[{{\bf E\+M\+D\+B} $\ast$}]{, }
\item[{void $\ast$}]{, }
\item[{void($\ast$)(void $\ast$, unsigned char $\ast$, {\bf Entry} $\ast$)}]{, }
\item[{void($\ast$)(void $\ast$)}]{, }
\item[{void($\ast$)(void $\ast$, char $\ast$)}]{}
\end{DoxyParamCaption}
)}\label{emdb_8h_afbf6079856996f619646712e7a698573}
